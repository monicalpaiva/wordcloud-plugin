...
/**
 * @file plugins/blocks/wordCloud/wordCloudBlockPlugin.inc.php
 *
 * Copyright (c) 2014-2018 Simon Fraser University
 * Copyright (c) 2003-2018 John Willinsky
 * Distributed under the GNU GPL v2. For full terms see the file docs/COPYING.
 *
 * @class wordCloudBlockPlugin
 * @ingroup plugins_blocks_wordCloud
 *
 * @brief Class for wordCloud block plugin
 */
...
class wordCloudBlockPlugin extends BlockPlugin {
	/**
	...
	function getDisplayName() {
		return __('plugins.block.wordCloud.displayName');
	}
	...
	function getDescription() {
		return __('plugins.block.wordCloud.description');
	}

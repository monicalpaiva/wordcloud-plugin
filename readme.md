...
## Install
 * Copy the release source or unpack the release package into the OJS i.e. OMP plugins/blocks/wordCloud/ folder.
 * Go to Settings -> Website -> Plugins -> Block Plugins -> wordCloud Plugin and enable the plugin.
